...
public class RSQLite {
    ...
    public static SEXP RSQLite_rsqlite_connect(String path, boolean allowExtention, SEXP flags, String vfs) {
        throw new EvalException("TODO: RSQLite_rsqlite_connect");
    }

    public static SEXP RSQLite_rsqlite_disconnect(SEXP con) {
        throw new EvalException("TODO: RSQLite_rsqlite_disconnect");
    }

    public static SEXP RSQLite_rsqlite_copy_database(String from, String to) {
